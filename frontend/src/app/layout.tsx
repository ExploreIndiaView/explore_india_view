...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <meta name="google-site-verification" content="Bl7pcaHwWNLlXCpWvWZhpmLP9NIKlFLNBvCxNYNxWSA" />
      <meta name="google-adsense-account" content="ca-pub-8518455156221027"/>
      <body
